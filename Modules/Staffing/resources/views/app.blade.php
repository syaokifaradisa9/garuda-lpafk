...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/logo/icon-logo.png') }}" type="image/x-icon">
...
<body>
                ...
                <div class="sidebar-wrapper active">
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            ...
                            <li
                                class="sidebar-item @if(Request::is("staffing/unit")) active @endif">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2024 &copy; LPAFK Banjarbaru</p>
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script src="{{ asset('assets/vendor/simple-datatables/umd/simple-datatables.js') }}"></script>
